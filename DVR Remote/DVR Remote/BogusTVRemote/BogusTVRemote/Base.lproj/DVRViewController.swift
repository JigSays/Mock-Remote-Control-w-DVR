...
//  BogusTVRemote
//
//  Created by Jordan Gary on 2/26/19.
...
class DVRViewController: UIViewController {
    ...
    @IBAction func playButtonPressed(_ sender: UIButton) {
        if recordButtonInProgress == false
        {
            ...
            func forcePlayHandler(alert: UIAlertAction!) {
                ...
                let title = "Alert"
                let message = "Current operation has been overriden per user request"
    ...
    @IBAction func fastRewindButtonPressed(_ sender: UIButton) {
        if playButtonInProgress == true && stopButtonInProgress == false {
            ...
            let title = "Warning"
            let message = "Cannot rewind while stopped or recording"
            ...
            let confirmAction = UIAlertAction(title: "Force Rewind", style: .default, handler: forceFastRewindHandler)
    ...
    @IBAction func switchToRemoteViewController(_ sender: UIBarButtonItem) {
